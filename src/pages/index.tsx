  ...
  return (
    <>
      ...
      <Layout>
        ...
        >
          <div className="fc bg-rd h-full items-start justify-start pt-8 md:w-3/5 md:justify-center">
            <div className="fc space-y-4 md:space-y-12">
              ...
              <button className="p-main w-full border-2 px-4 py-2 transition-colors duration-300 hover:bg-white hover:text-black md:w-fit md:px-16 md:py-4">
                See Resume
              </button>
            </div>
          </div>
        ...
        >
          <h2 className="pb-8">My Projects</h2>
